...
#define KEY_VALUE_MAX_LENGTH 50        // maximale anzahl an keyValues
KeyValue store[KEY_VALUE_MAX_LENGTH];  // Die Struktur muss nicht hier definiert werden,
// weil sie schon in keyValStore.h ist
